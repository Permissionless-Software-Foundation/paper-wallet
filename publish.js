...
async function publish() {
  try {
    ...
    const troutWif = process.env.PAPERWALLET_WIF;
    if (!troutWif) {
      throw new Error(
        "WIF for paperwallet.fullstack.casg not detect. Add it to the PAPERWALLET_WIF environment variable."
      );
    }
